...
# This file was *autogenerated* from the file factor_embed.sage
from sage.all_cmdline import *   # import sage library

_sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_7 = Integer(7)
from sage.all import QuadraticField, PolynomialRing, sqrt, QQ
from functions_resolvent_calculation import calc_rootis

def factor_multivar_over_Qsqrt_neg(j, *, pos=_sage_const_0 , clear_denom=True, verbose=True):
    """
    ...
    K = QuadraticField(-j, names=('s',)); (s,) = K._first_ngens(1)
    sqrt_neg_j = sqrt(-j)
...
# Example run
for j in range(_sage_const_3 ,_sage_const_7 ):
